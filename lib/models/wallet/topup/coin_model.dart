...
ItemModelCoinPriceInq itemModelCoinPriceInqFromJson(String str) => ItemModelCoinPriceInq.fromJson(json.decode(str));

String itemModelCoinPriceInqToJson(ItemModelCoinPriceInq data) => json.encode(data.toJson());
...
class ItemModelCoinPriceInq {
  ...
  factory ItemModelCoinPriceInq.fromJson(Map<String, dynamic> json) => ItemModelCoinPriceInq(
