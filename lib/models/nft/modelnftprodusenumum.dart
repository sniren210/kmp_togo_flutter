class ModelNFTKonsumenUmum {
  List<Data>? data;
  Meta? meta;

  ModelNFTKonsumenUmum({this.data, this.meta});

  ModelNFTKonsumenUmum.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Nft {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['produsenId'] = this.produsenId;
    data['name'] = this.name;
