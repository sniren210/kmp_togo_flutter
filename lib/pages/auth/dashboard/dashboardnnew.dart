                      ...
                      children: [
                                          ...
                                          GridView(
                                              ...
                                              children: [
                                                cardmenu('Topup',
                                                  ...
                                                  if (model.items!.user.role == 'konsumen1' ||
                                                      model.items!.user.role ==
                                                          'konsumen2' ||
                                                      model.items!.user.role ==
                                                          'produsen') {
                                                    Navigator.push(
                        ...
                        model.busy
                            ...
                            : Container(
                                ...
                                child: Column(
                                  children: [
                                    model.items!.user.role == 'konsumen1'
                                        ? Column(
                                            children: [
                                              Container(
                                                padding: EdgeInsets.only(
                                        ...
                                        : Container(),
                                    model.items!.user.role == 'produsen' ||
                                            model.items!.user.role ==
                                                'konsumen1' ||
                                            model.items!.user.role ==
                                                'konsumen2' ||
